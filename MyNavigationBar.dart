...
import 'package:untitled8/prescriptionScreen/prescriptionPage.dart';
...
class _MyNavigationBarState extends State<MyNavigationBar > {
  ...
  static  List<Widget> _widgetOptions = <Widget>[
    DialogExample(),
    patientDiagnosis(),
    Text('Profile Page', style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold)    // Text('Search Page', style: TextStyle(fontSize: 35, fontWeight: FontWeight.bold)),
    ),
  ];
